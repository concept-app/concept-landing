...
Concept AI Labs, Inc. ("Concept," "we," "us," or "our") is committed to protecting the privacy of individuals whose personal data we process. This Privacy Policy describes how Concept AI Labs, Inc. collects, uses, discloses, and protects personal data in connection with our websites, applications, and services (collectively, the "Services").

Concept provides AI coworkers that integrate with customer-authorized third-party data sources to automate and scale knowledge work.

Questions about this Privacy Policy may be directed to [contact@concept.dev](mailto:contact@concept.dev).

## 1. Scope

This Privacy Policy applies to personal data processed by Concept in connection with:
...
- Communications with Concept (support tickets, emails, feedback)
- Billing and payment-related contact information

### b. Integrated Third-Party Data (Customer Data)

At the direction of customers and subject to explicit authorization, Concept may access and process data from third-party services such as:

- Email (e.g., Gmail)
- Messaging and collaboration tools (e.g., Slack)
- Productivity and documentation tools (e.g., Google Workspace, Notion)
- CRM and sales platforms (e.g., Salesforce, HubSpot)
- Project management tools (e.g., Linear)
- Revenue intelligence platforms (e.g., Gong)

Concept only accesses data that customers explicitly authorize through each integration and only for the purpose of providing the Services. The scope of access is limited by the permissions granted by the customer and the configuration of each integration.
...
- Data is processed for the specific task requested
- Customers retain control over connected data sources and may revoke access at any time

Concept's AI features operate on customer-provided and customer-authorized data and are designed to respect permission boundaries and organizational access controls.

## 5. Legal Bases for Processing (GDPR)

Where applicable, Concept processes personal data based on:
...
Concept may share personal data with:
...
If Concept receives a legal request, subpoena, or court order for Customer Data, Concept will, to the extent legally permitted, provide prompt notice to the affected Customer and cooperate with the Customer in responding to such request.

## 7. Data Security

Concept implements administrative, technical, and organizational safeguards designed to protect personal data, including:
...
Concept retains personal data only as long as necessary to:
...
Concept may process and store personal data in the United States and other jurisdictions. Where required, Concept relies on appropriate safeguards such as standard contractual clauses to support international data transfers.
...
Requests may be submitted to [contact@concept.dev](mailto:contact@concept.dev).
...
- Request deletion of personal data
- Opt out of the sale or sharing of personal data (Concept does not sell personal data)
...
The Services are not intended for children under 13, and Concept does not knowingly collect personal data from children.
